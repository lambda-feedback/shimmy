...
func (_m *MockAdapter[I, O]) Send(_a0 context.Context, _a1 I, _a2 worker.SendConfig) (O, error) {
	...
	var r0 O
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, I, worker.SendConfig) (O, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, I, worker.SendConfig) O); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(O)
	}

	if rf, ok := ret.Get(1).(func(context.Context, I, worker.SendConfig) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockAdapter_Send_Call[I, O]) Run(run func(_a0 context.Context, _a1 I, _a2 worker.SendConfig)) *MockAdapter_Send_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(I), args[2].(worker.SendConfig))
	})
	return _c
}
...
func (_c *MockAdapter_Send_Call[I, O]) RunAndReturn(run func(context.Context, I, worker.SendConfig) (O, error)) *MockAdapter_Send_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
