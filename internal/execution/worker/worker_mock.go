...
func (_m *MockWorker[I, O]) Stop(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
type MockWorker_Stop_Call[I interface{}, O interface{}] struct {
	*mock.Call
}

// Stop is a helper method to define mock.On call
//   - _a0 context.Context
func (_e *MockWorker_Expecter[I, O]) Stop(_a0 interface{}) *MockWorker_Stop_Call[I, O] {
	return &MockWorker_Stop_Call[I, O]{Call: _e.mock.On("Stop", _a0)}
}

func (_c *MockWorker_Stop_Call[I, O]) Run(run func(_a0 context.Context)) *MockWorker_Stop_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWorker_Stop_Call[I, O]) Return(_a0 error) *MockWorker_Stop_Call[I, O] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWorker_Stop_Call[I, O]) RunAndReturn(run func(context.Context) error) *MockWorker_Stop_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
