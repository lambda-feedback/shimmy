...
func (_m *MockWorker[I, O]) Read(_a0 context.Context, _a1 worker.ReadParams) (O, error) {
	...
	var r0 O
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, worker.ReadParams) (O, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, worker.ReadParams) O); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(O)
	}

	if rf, ok := ret.Get(1).(func(context.Context, worker.ReadParams) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockWorker_Read_Call[I, O]) Run(run func(_a0 context.Context, _a1 worker.ReadParams)) *MockWorker_Read_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(worker.ReadParams))
	})
	return _c
}
...
func (_c *MockWorker_Read_Call[I, O]) RunAndReturn(run func(context.Context, worker.ReadParams) (O, error)) *MockWorker_Read_Call[I, O] {
	_c.Call.Return(run)
	return _c
}

// Send provides a mock function with given fields: _a0, _a1, _a2
func (_m *MockWorker[I, O]) Send(_a0 context.Context, _a1 I, _a2 worker.SendParams) (O, error) {
...
func (_c *MockWorker_Send_Call[I, O]) Run(run func(_a0 context.Context, _a1 I, _a2 worker.SendParams)) *MockWorker_Send_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWorker_Send_Call[I, O]) RunAndReturn(run func(context.Context, I, worker.SendParams) (O, error)) *MockWorker_Send_Call[I, O] {
	_c.Call.Return(run)
	return _c
}

// Start provides a mock function with given fields: _a0, _a1
func (_m *MockWorker[I, O]) Start(_a0 context.Context, _a1 worker.StartParams) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *MockWorker_Start_Call[I, O]) Run(run func(_a0 context.Context, _a1 worker.StartParams)) *MockWorker_Start_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWorker_Start_Call[I, O]) RunAndReturn(run func(context.Context, worker.StartParams) error) *MockWorker_Start_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockWorker[I, O]) Wait(_a0 context.Context) (worker.ExitEvent, error) {
	ret := _m.Called(_a0)
	...
	var r0 worker.ExitEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (worker.ExitEvent, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) worker.ExitEvent); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(worker.ExitEvent)
	}
...
func (_c *MockWorker_Wait_Call[I, O]) Return(_a0 worker.ExitEvent, _a1 error) *MockWorker_Wait_Call[I, O] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWorker_Wait_Call[I, O]) RunAndReturn(run func(context.Context) (worker.ExitEvent, error)) *MockWorker_Wait_Call[I, O] {
	_c.Call.Return(run)
	return _c
}

// WaitFor provides a mock function with given fields: _a0, _a1
func (_m *MockWorker[I, O]) WaitFor(_a0 context.Context, _a1 time.Duration) (worker.ExitEvent, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 worker.ExitEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Duration) (worker.ExitEvent, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Duration) worker.ExitEvent); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(worker.ExitEvent)
	}
...
func (_c *MockWorker_WaitFor_Call[I, O]) Return(_a0 worker.ExitEvent, _a1 error) *MockWorker_WaitFor_Call[I, O] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWorker_WaitFor_Call[I, O]) RunAndReturn(run func(context.Context, time.Duration) (worker.ExitEvent, error)) *MockWorker_WaitFor_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
