...
func (_m *MockSupervisor[I, O]) Send(ctx context.Context, data I) (*supervisor.Result[O], error) {
	...
	var r0 *supervisor.Result[O]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, I) (*supervisor.Result[O], error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, I) *supervisor.Result[O]); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*supervisor.Result[O])
		}
	}
...
func (_c *MockSupervisor_Send_Call[I, O]) Return(_a0 *supervisor.Result[O], _a1 error) *MockSupervisor_Send_Call[I, O] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSupervisor_Send_Call[I, O]) RunAndReturn(run func(context.Context, I) (*supervisor.Result[O], error)) *MockSupervisor_Send_Call[I, O] {
	_c.Call.Return(run)
	return _c
}

// Shutdown provides a mock function with given fields: ctx
func (_m *MockSupervisor[I, O]) Shutdown(ctx context.Context) (supervisor.WaitFunc, error) {
	ret := _m.Called(ctx)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (supervisor.WaitFunc, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) supervisor.WaitFunc); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSupervisor_Shutdown_Call[I, O]) Return(_a0 supervisor.WaitFunc, _a1 error) *MockSupervisor_Shutdown_Call[I, O] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSupervisor_Shutdown_Call[I, O]) RunAndReturn(run func(context.Context) (supervisor.WaitFunc, error)) *MockSupervisor_Shutdown_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSupervisor[I, O]) Suspend(ctx context.Context) (supervisor.WaitFunc, error) {
	ret := _m.Called(ctx)
...
func (_c *MockSupervisor_Suspend_Call[I, O]) Return(_a0 supervisor.WaitFunc, _a1 error) *MockSupervisor_Suspend_Call[I, O] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSupervisor_Suspend_Call[I, O]) RunAndReturn(run func(context.Context) (supervisor.WaitFunc, error)) *MockSupervisor_Suspend_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
