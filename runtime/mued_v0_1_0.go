...
func (muEdV010) EncodeHealth(legacyResult map[string]any) map[string]any {
	return MuEdToHealthResponse(legacyResult)
}
...
func (muEdV010) EncodeChatHealth(result map[string]any) map[string]any {
	return MuEdToChatHealthResponse(result)
}
